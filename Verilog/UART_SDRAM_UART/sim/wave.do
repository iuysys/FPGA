...
add wave -noupdate /UART_SDRAM_UART_tb/UART_SDRAM_UART_inst/UART_Rxd_inst/rx_busy
add wave -noupdate -radix hexadecimal /UART_SDRAM_UART_tb/UART_SDRAM_UART_inst/UART_Rxd_inst/rx_data
add wave -noupdate -radix hexadecimal /UART_SDRAM_UART_tb/UART_SDRAM_UART_inst/UART_Rxd_CTRL_inst/rx_data_out
add wave -noupdate -radix unsigned /UART_SDRAM_UART_tb/UART_SDRAM_UART_inst/sdram_2port_top_inst/sdram_fifo_write/wrreq
add wave -noupdate -radix unsigned /UART_SDRAM_UART_tb/UART_SDRAM_UART_inst/sdram_2port_top_inst/sdram_fifo_write/wrusedw
add wave -noupdate -radix hexadecimal /UART_SDRAM_UART_tb/UART_SDRAM_UART_inst/sdram_2port_top_inst/sdram_fifo_write/data
add wave -noupdate -radix hexadecimal /UART_SDRAM_UART_tb/UART_SDRAM_UART_inst/sdram_2port_top_inst/sdram_fifo_write/q
...
add wave -noupdate /UART_SDRAM_UART_tb/SDRAM_BANK
...
WaveRestoreCursors {{Cursor 1} {1294756 ns} 0}
...
update
WaveRestoreZoom {1200800 ns} {1536800 ns}
