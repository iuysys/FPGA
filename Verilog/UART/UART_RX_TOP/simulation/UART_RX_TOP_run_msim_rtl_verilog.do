...
add wave *
add wave -position end  sim:/UART_RX_TOP_vlg_tst/i1/receive
add wave -position end  sim:/UART_RX_TOP_vlg_tst/i1/STATE
add wave -position end  sim:/UART_RX_TOP_vlg_tst/i1/UART_RX_FIFO_inst/rdempty
add wave -position end  sim:/UART_RX_TOP_vlg_tst/i1/UART_RX_FIFO_inst/wrclk
add wave -position end  sim:/UART_RX_TOP_vlg_tst/i1/UART_RX_FIFO_inst/wrreq
view structure
view signals
run -all
