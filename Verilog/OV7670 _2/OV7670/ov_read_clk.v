...
module  ov_read_clk_altclkctrl_6df
	( 
	clkselect,
	ena,
	inclk,
...
`endif
	...
	assign
		...
		inclk_wire = {inclk},
		outclk = wire_clkctrl1_outclk;
endmodule //ov_read_clk_altclkctrl_6df
//VALID FILE
...
module ov_read_clk (
	...
	ov_read_clk_altclkctrl_6df	ov_read_clk_altclkctrl_6df_component (
				.clkselect (sub_wire1),
				.ena (sub_wire2),
				.inclk (sub_wire4),
				.outclk (sub_wire0));
...
// Retrieval info: GEN_FILE: TYPE_NORMAL ov_read_clk.v TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL ov_read_clk.inc FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL ov_read_clk.cmp FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL ov_read_clk.bsf FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL ov_read_clk_inst.v TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL ov_read_clk_bb.v FALSE
